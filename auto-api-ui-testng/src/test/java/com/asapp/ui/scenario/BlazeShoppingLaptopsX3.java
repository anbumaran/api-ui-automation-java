...
@Test(testName = "BlazeShoppingLaptopsX3")
public class BlazeShoppingLaptopsX3 extends BaseTestBlazeShopping {

    ServiceObject serviceObject = new ServiceObject();

    private static WebDriver driver;
    private static final String TEST_NAME = "Blaze Shopping Laptops X3";
