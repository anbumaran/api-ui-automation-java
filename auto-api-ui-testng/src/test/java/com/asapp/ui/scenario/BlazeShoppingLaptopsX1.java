...
@Test(testName = "BlazeShoppingLaptopsX1")
public class BlazeShoppingLaptopsX1 extends BaseTestBlazeShopping {

    ServiceObject serviceObject = new ServiceObject();

    private static WebDriver driver;
    private static final String TEST_NAME = "Blaze Shopping Laptops X1";
