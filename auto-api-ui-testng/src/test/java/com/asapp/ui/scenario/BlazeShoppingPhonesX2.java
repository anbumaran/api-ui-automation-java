...
@Test(testName = "BlazeShoppingPhonesX2")
public class BlazeShoppingPhonesX2 extends BaseTestBlazeShopping {

    ServiceObject serviceObject = new ServiceObject();

    private static WebDriver driver;
    private static final String TEST_NAME = "Blaze Shopping Phones X2";
