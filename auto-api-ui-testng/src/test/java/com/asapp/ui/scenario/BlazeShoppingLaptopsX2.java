...
@Test(testName = "BlazeShoppingLaptopsX2")
public class BlazeShoppingLaptopsX2 extends BaseTestBlazeShopping {

    ServiceObject serviceObject = new ServiceObject();

    private static WebDriver driver;
    private static final String TEST_NAME = "Blaze Shopping Laptops X2";
