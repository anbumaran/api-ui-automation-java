...
<div>
    <table border="1">
        ...
        padding-bottom: 6px;">${appName} - Automation Report - ${env}
            </th>
        </tr>
    </table>
</div>
...
<table border="1">
    <tr>
        <th style="font-size:18px;font-weight:bold; text-align:center;
         padding:20px;padding-top: 6px;padding-bottom: 6px;">Test Results
        </th>
    </tr>
</table>
<table border="1">
    ...
    <tr style="font-size:15px;font-weight:bold">
        ...
        <td style="color:blue">${testResults.name}</td>
...
<table border="1">
    <th style="font-size:18px;font-weight:bold; text-align:center;
padding:20px;padding-top: 6px;padding-bottom: 6px;">Failed Tests
    </th>
</table>
